...
import { ShieldCheckIcon, MailIcon, LockIcon, AlertCircleIcon, SparklesIcon } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const loginMutation = api.auth.login.useMutation({
    onSuccess: async (data) => {
      console.log('[Login] Login successful, setting session on client...');
      ...
      if (data.session) {
        ...
        console.log('[Login] Session set successfully, redirecting...');
      }
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        <div className="absolute top-20 left-20 w-96 h-96 bg-cyber-500/10 rounded-full blur-3xl animate-pulse-slow" />
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-cyber-600/10 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '1s' }} />
      </div>
